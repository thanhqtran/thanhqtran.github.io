...
Conventionally, Solow growth accounting provides a tractable framework for us to see the contribution of capital, labor and TFP (or Solow residual). However, the problem with this method is that it assumes perfect efficient allocation of inputs. That is, there is no distortion in the economy, capital and labor are allocated perfectly so that the sole contribution to TFP is simply technological progress. In the long-term, this assumption may be reasonable, however, in the short term, it becomes too restrictive. 
Thus, Petrin & Levinsohn (2013) provide a method to further decompose Solow residual growth into 2 portions: TE (technological efficiency, a.k.a technological progress) and RE (reallocation efficiency).
We thus call the Solow residual as APG (aggregate productivity growth), use the [EUKLEMS](https://euklems.eu/?doing_wp_cron=1648617094.1887850761413574218750) sector-specific micro-level data to quantify such a decomposition.
