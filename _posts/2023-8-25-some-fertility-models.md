...
$$
If wife's wage is lower than child care cost $(w_f < p_s)$, she provides childcare by herself and $s=0$. Otherwise, the couple buys as much childcare as possible available in the market $(s=\bar{s})$. Comparative statics gives
$$
